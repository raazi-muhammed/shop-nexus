			...
			<section className="bg-primary rounded-4 mt-2 text-white p-4">
				{userData.plusMember?.active ? (
					<Link to={"shop-nexus-plus"}>
						...
						<p className="text-small text-secondary m-0">View Your Benifits</p>
					</Link>
				) : (
					<Link to={"/shop-nexus-plus"}>
						<div>
							<button
								className={"btn text-light fw-light text-start w-100 p-0"}>
								Become <span className="fw-bold text-white"> Shop Nexus+</span>{" "}
								Member
							</button>
